...
function AureanCard({ goal, onDelete, onUpdate }) {
  ...
  return (
    <div className="col-span-1 md:col-span-2 rounded-2xl overflow-hidden relative" style={{ background: 'linear-gradient(135deg, #0D1B4B 0%, #1A237E 40%, #283593 100%)', boxShadow: '0 8px 40px rgba(13,27,75,0.35)' }}>
      ...
      <div className="relative p-7">
        ...
        <div className="flex items-start justify-between mb-7">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="font-display text-[18px] md:text-[22px] font-bold text-white">{goal.name}</h3>
        ...
        {/* Main stats */}
        <div className="grid grid-cols-2 md:grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-7">
          {[
...
export default function Goals() {
  ...
  return (
    <div className="section-enter">
      ...
      {/* Summary */}
      <div className="grid grid-cols-2 md:grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
        {[
          ...
          <div key={label} className="bg-white rounded-2xl border border-[#EDE8DC] px-5 py-4" style={{ boxShadow:'0 2px 12px rgba(180,150,60,0.1)' }}>
            ...
            <p className="font-display text-[18px] md:text-[22px] font-bold mt-1" style={{ color }}>{value}</p>
          </div>
        ))}
      </div>
