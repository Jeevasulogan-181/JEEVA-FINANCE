import { BarChart2, Banknote, PiggyBank, CreditCard, Calendar, StickyNote, TrendingDown, Target, ShoppingCart } from 'lucide-react'
...
const NAV = [
  ...
  { section: 'Expenses', items: [
    { id: 'daily',          label: 'Daily Expenses',   icon: ShoppingCart },
  ]},
